...
public class TicketRequest {
    ...
    private String cap;
    private String privacyMarketing; // es. "acconsento" oppure "non_acconsento"

    // Dati ordine
    private String metodoConsegna; // es. "corriere", "digitale", "negozio"
    ...
    // Getter e Setter per i dati utente
    ...
    // Getter e Setter per i dati ordine
